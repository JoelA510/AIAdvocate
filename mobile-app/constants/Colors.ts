/**
 * Centralized Love Never Fails / AI Advocate brand palette.
 * These values feed both the Paper theme and plain React Native styles.
 */
export const BrandPalette = {
  /** Core teal pulled from the wordmark */
  primary: "#008C95",
  ...
  mist: "#D7F1F3",
  /** Golden accent taken from campaign collateral */
  sunrise: "#F6B756",
