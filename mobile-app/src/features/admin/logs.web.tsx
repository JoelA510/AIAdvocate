...
import { Text, Button, Card, useTheme, ActivityIndicator, Searchbar } from "react-native-paper";
      ...
      <View style={[styles.content, { paddingBottom: insets.bottom + 12 }]}>
        {loading ? (
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <Card style={styles.card}>
                <Card.Title
                  ...
                  right={(props) => (
                    <Text {...props} style={{ marginRight: 16, fontSize: 12 }}>
            ...
            ListEmptyComponent={
              <Text style={{ textAlign: "center", marginTop: 20 }}>No logs found.</Text>
            }
          />
        )}
      </View>
