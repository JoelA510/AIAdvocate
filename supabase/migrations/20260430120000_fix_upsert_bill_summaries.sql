-- Fix regression in upsert_bill_and_translation that prevented summaries and embeddings from being saved for existing bills.
-- This migration restores the missing fields to the ON CONFLICT clause and uses COALESCE to follow the "preserve" rule.
