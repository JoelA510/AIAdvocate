...
const SYS_PROMPT = `You are a legislative explainer. Produce a 2–4 sentence, plain-English summary suitable for the general public. Avoid legalese. Keep it neutral, factual, and ≤ 120 words.`;
